 ...
 * @author USER
 */
public class AppointmentTable extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AppointmentTable.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel30.setText("Appointment Table");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.getLogger(AppointmentTable.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }

       java.awt.EventQueue.invokeLater(() -> new AppointmentTable().setVisible(true));
        // ----------------------------------------------------------------------------
